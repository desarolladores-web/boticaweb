...
<body class="bg-light">
  ...
  <!-- CARRUSEL -->
  <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000" style="margin-top: -30px;">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <section class="hero-section d-flex align-items-center justify-content-center text-center text-white position-relative"
          ...
          <div class="container px-3 position-relative">
            ...
            <p class="lead text-white mb-4">Atención personalizada y medicamentos confiables <br class="d-none d-md-block">para ti y tu familia, cada día.</p>
      ...
      <div class="carousel-item">
        <section class="hero-section d-flex align-items-center justify-content-center text-center text-white position-relative"
          ...
          <div class="overlay"></div>
          <div class="container px-3 position-relative">
            <h1 class="display-5 fw-bold text-white">Todo lo que necesitas <span class="text-success">al instante</span></h1>
            <p class="lead text-white mb-4">Desde analgésicos hasta vitaminas,<br class="d-none d-md-block">encuéntralo fácil, rápido y cerca de casa.</p>
