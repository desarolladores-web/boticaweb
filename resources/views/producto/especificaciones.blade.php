...
<div class="col-md-11">
    <div class="bg-white border rounded-4 p-4 shadow d-flex align-items-start" style=" border-radius: 25px ;font-size: 15px; color: #333; box-shadow: 0 0 12px rgba(0,0,0,0.08);">
        
        {{-- Imagen a la izquierda --}}
        <div class="me-4 d-flex align-items-center justify-content-center" style="width: 600px; height: 500px;">
                @if($producto->imagen)
...
<ul class="list-group list-group-flush mb-4" style="font-size: 14px;">
    <li class="list-group-item border-0 custom-text-color"><strong>Principio Activo:</strong> {{ $producto->principio_activo ?? 'N/A' }}</li>
    <li class="list-group-item border-0 custom-text-color"><strong>Stock:</strong> {{ $producto->stock }}</li>
    <li class="list-group-item border-0 custom-text-color"><strong>Vencimiento:</strong> {{ \Carbon\Carbon::parse($producto->fecha_vencimiento)->format('d/m/Y') }}</li>
    <li class="list-group-item border-0 custom-text-color"><strong>Categoría:</strong> {{ $producto->categoria->nombre ?? 'N/A' }}</li>
    <li class="list-group-item border-0 custom-text-color"><strong>Laboratorio:</strong> {{ $producto->laboratorio->nombre_laboratorio ?? 'N/A' }}</li>
</ul>
