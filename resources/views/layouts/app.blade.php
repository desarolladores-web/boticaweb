                                ...
                                fetch(url, {
                                    ...
                                    .then(data => {
                                        ...
                                        if (data.producto_id && data.cantidad !== undefined) {
                                            const cantidadElem = document.getElementById('cantidad-' + data
                                                .producto_id);
                                            if (cantidadElem) {
                                        ...
                                        if (data.eliminado && data.producto_id) {
                                            const itemElem = document.getElementById('item-' + data
                                            .producto_id);
                                            if (itemElem) {
                                                itemElem.remove();
                                            }
                                            ...
                                            fetch(window.location.href)
                                                ...
                                                .then(html => {
                                                    const doc = new DOMParser().parseFromString(html,
                                                        'text/html');
                                                    const nuevoBloque = doc.querySelector(
                                                        '#carrito-container-' + data
                                                        .producto_id);
                                                    const viejoBloque = document.getElementById(
                                                        'carrito-container-' + data
                                                        .producto_id);
                                            ...
                                            fetch(window.location.href)
                                                ...
                                                .then(html => {
                                                    const doc = new DOMParser().parseFromString(html,
                                                        'text/html');
                                                    const nuevoBloque = doc.querySelector(
                                                        '#carrito-container-' + data.producto_id);
                                                    const viejoBloque = document.getElementById(
                                                        'carrito-container-' + data.producto_id);
                                                    if (nuevoBloque && viejoBloque) {
                                                        viejoBloque.innerHTML = nuevoBloque.innerHTML;
