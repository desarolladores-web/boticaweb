                    ...
                    <div class="card-body border-top">
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            ...
                            <form action="{{ route('productos.index') }}" method="GET"
                                ...
                                <div class="right">
                                    <form action="{{ route('productos.buscar') }}" method="get" class="search-group">
                                        <input type="text" class="form-control styled-input" name="buscar"
                            ...
                            <form id="importForm" action="{{ route('productos.importar') }}" method="POST"
                                enctype="multipart/form-data" class="d-flex flex-wrap align-items-center gap-2">
                                @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-actions">
                                            <form action="{{ route('productos.destroy', $producto->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-sm" href="{{ route('productos.show', $producto->id) }}"
                                                    title="Ver">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a class="btn btn-sm" href="{{ route('productos.edit', $producto->id) }}"
                                                    title="Editar">
                            ...
                            <ul class="inline-flex items-center -space-x-px">
                                ...
                                <li>
                                    <a href="{{ $productos->url(1) }}"
                                        class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200 text-gray-600 hover:bg-gray-300">
                                    ...
                                    @else
                                        <li>
                                            <a href="{{ $productos->url($i) }}"
                                                class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300">
                                                {{ $i }}
                                            </a>
                                        </li>
                                    @endif
