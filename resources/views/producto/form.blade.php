    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="form-floating mb-3">
                        <input type="text" name="nombre"
                            class="form-control styled-input @error('nombre') is-invalid @enderror"
                    ...
                    <div class="row">
                        <div class="col-md-6 form-floating mb-3">
                            <input type="text" name="codigo"
                                class="form-control styled-input @error('codigo') is-invalid @enderror"
                                value="{{ old('codigo', $producto?->codigo) }}" placeholder="Código">
                            {!! $errors->first('codigo', '<div class="invalid-feedback">:message</div>') !!}
                            <label for="codigo">Código</label>
                        </div>
                        <div class="col-md-6 form-floating mb-3">
                            <input type="text" name="principio_activo"
                                class="form-control styled-input @error('principio_activo') is-invalid @enderror"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div id="editor"
                            style="height: 120px; background: #fff; border: 2px solid #ced4da; border-radius: 0.375rem; padding: 10px;">
        ...
        <div class="col-md-6">
            <div class="card mb-1 shadow-sm">
                ...
                <div class="card-body">
                    <div class="form-floating mb-3">
                        <input type="text" name="pvp1"
                            class="form-control styled-input @error('pvp1') is-invalid @enderror"
                            value="{{ old('pvp1', $producto?->pvp1) }}" placeholder="PVP1">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="stock"
                            class="form-control styled-input @error('stock') is-invalid @enderror"
                            value="{{ old('stock', $producto?->stock) }}" placeholder="Stock">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="stock_min"
                            class="form-control styled-input @error('stock_min') is-invalid @enderror"
                            value="{{ old('stock_min', $producto?->stock_min) }}" placeholder="Stock mínimo">
                    ...
                    <div class="form-floating mb-3">
                        <input type="date" name="fecha_vencimiento"
                            class="form-control styled-input @error('fecha_vencimiento') is-invalid @enderror"
...
<div class="container-fluid">
        ...
        <div class="col-md-6">
            <div class="card mt-5 mb-3 shadow-sm p-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Categoría -->
                    <div class="form-floating mb-3">
                        <input list="categorias" name="categoria_nombre"
                            class="form-control styled-input @error('categoria_nombre') is-invalid @enderror"
                            value="{{ old('categoria_nombre', $producto->categoria->nombre ?? '') }}"
                    ...
                    <!-- Laboratorio -->
                    <div class="form-floating mb-3">
                        <input list="laboratorios" name="laboratorio_nombre"
                            class="form-control styled-input @error('laboratorio_nombre') is-invalid @enderror"
                            value="{{ old('laboratorio_nombre', $producto->laboratorio->nombre_laboratorio ?? '') }}"
                    ...
                    <!-- Presentación -->
                    <div class="form-floating mb-3">
                        <input list="presentaciones" name="presentacion_tipo"
                            class="form-control styled-input @error('presentacion_tipo') is-invalid @enderror"
                            value="{{ old('presentacion_tipo', $producto->presentacion->tipo_presentacion ?? '') }}"
        ...
        <div class="col-md-6">
            ...
            <div class="card mb-3 shadow-sm p-3">
                ...
                <div class="card-body">
                    ...
                    <form class="file-upload-form" method="POST" action="{{ route('productos.store') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <label for="file" class="file-upload-label">
                            <div class="file-upload-text" id="uploadContent"
                                style="display: {{ isset($producto) && !empty($producto->imagen) ? 'none' : 'block' }};">
                                ...
                                <p>o</p>
                                <span class="browse-button">Explorar imagen</span>
                            </div>

                            <input id="file" type="file" name="imagen" accept="image/*"
                            ...
                            @else
                                <img id="preview" class="file-upload-preview"
                                    style="max-width: 550px; display: none;" alt="Vista previa">
                            @endif
                        </label>
    ...
    <div class="d-flex justify-content-between text-center ">
        <button href="{{ route('productos.index') }}" class="btn btn-secondary">Cancelar</button>
        <button type="submit" class="btn " href>Guardar</button>
    </div>
